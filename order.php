...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav_content">
        ...
        $employee = mysqli_query($konek,"SELECT  * FROM `transaksi_pending` WHERE 
        `status_bayar` = 'belum_bayar' GROUP by `id_keranjang`;");
        $numNo = 1;
        $totItem = 0;
        $hrgaTotal = 0;
		$nomorHp = "";
        while($row = mysqli_fetch_array($employee))
        {
            ...
            $getUser = "SELECT * FROM `detail_akun` WHERE `id_akun` = '" 
            . $row['id_akun'] . "';";
           ...
           `id_keranjang` = '" .  $row['id_keranjang'] . "';";
            ...
            echo "<td> 
            <a class='btn btn-success' href = 'konfirmasi_pesanan.php?id_keranjang=" .$row['id_keranjang']  . 
            "'<button id =".'"edit' . $numNo . '"'." href='" . "'>
			...
			<div>
            <a class='btn btn-info' href = '" .$row['gambar_transaksi']  . "'<button id =".'"edit' . $numNo . 
            '"'." href='" . "'>
			...
			<a class='btn btn-danger' href = 'hapus_transaksi.php?id_keranjang=" .$row['id_keranjang']  . 
            "'<button id =".'"edit' . $numNo . '"'." href='" . "'>
		...
		<a class='btn btn-success' href = 'https://wa.me/+" . $nomorHp . 
            "'<button id =".'"edit' . $numNo . '"'." href='" . "'>
