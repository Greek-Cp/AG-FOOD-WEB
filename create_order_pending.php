<?php 
    ...
    if($_SERVER['REQUEST_METHOD']=='POST'){
        ...
        $insertTambahKeranjang = "INSERT INTO `keranjang_user`(`id_keranjang` , `id_akun` , `id_barang` , `total_harga`,`jumlah_item`) VALUES('','" . $id_akun . "','" . $id_barang . "','" . $total_harga . "','". $totalItem . "');";
